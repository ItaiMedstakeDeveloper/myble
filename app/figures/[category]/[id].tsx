...
function DiscipleSections({
  ...
  return (
    <>
      {detail.alsoKnownAs !== '' && (
        <Field label={SECTION_LABELS.alsoKnownAs[lang]} value={detail.alsoKnownAs} />
      )}
      <Field label={SECTION_LABELS.occupation[lang]} value={detail.occupation[lang]} />
      <Field label={SECTION_LABELS.calling[lang]} value={detail.calling[lang]} />
      <Field label={SECTION_LABELS.keyRole[lang]} value={detail.keyRole[lang]} />
      <Field label={SECTION_LABELS.notableMoment[lang]} value={detail.notableMoment[lang]} />
      <Field
        label={SECTION_LABELS.traditionAfter[lang]}
        value={detail.traditionAfter[lang]}
        tag={detail.traditionSourced ? SECTION_LABELS.tradition[lang] : undefined}
      />
...
function ProphetSections({
  ...
  return (
    <>
      <Field label={keyThemesLabel || PROPHET_LABELS.keyThemes[lang]} value={keyThemes} />
      <Field label={PROPHET_LABELS.summary[lang]} value={summary} />
      <Field label={PROPHET_LABELS.background[lang]} value={prophet.background[lang]} />
      <Field
      ...
      />
      <Field label={PROPHET_LABELS.bookOverview[lang]} value={prophet.bookOverview[lang]} />
      <Field
...
const styles = StyleSheet.create({
  ...
  tagText: { color: Zim.red, fontSize: 9, fontWeight: '700', letterSpacing: 0.5 },
  note: { fontSize: 12, lineHeight: 18, opacity: 0.6, fontStyle: 'italic', marginTop: 10 },
});
